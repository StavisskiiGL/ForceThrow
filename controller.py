...
class Control:
    """Класс, содержащий функции, вызываемые функцией controller в зависимости от того, в каком
    разделе игры (меню, настройки, пауза, окончание игры, положение между раундами, собственно игра)
    находятся игроки"""
